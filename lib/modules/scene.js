...
var _dialogue = require('./dialogue');var _dialogue2 = _interopRequireDefault(_dialogue);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/**
                                                                                                                                                                                       ...
                                                                                                                                                                                       */
class Scene extends _base2.default {
  constructor(...args) {
    super('scene', ...args);
  ...
  enter(res, ...args) {
    ...
    let options = _lodash2.default.isObject(args[0]) ? args.shift() : {};
    options = _lodash2.default.defaults({}, this.config, options);
    const dialogue = new _dialogue2.default(res, options, ...args);
    dialogue.scene = this;
  ...
  inDialogue(participants) {
    return _lodash2.default.keys(this.engaged).includes(participants);
  }}exports.default =
