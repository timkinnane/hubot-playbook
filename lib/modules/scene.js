...
var Scene = function (_Base) {
  ...
  function Scene() {
    ...
    _this.enterMiddleware = new _middleware2.default(_this);
  ...
  _createClass(Scene, [{
    ...
    */
    ...
    value: function enter(res) {
      ...
      if (_lodash2.default.isFunction(args[args.length - 1])) callback = args.pop();
    ...
    value: function processEnter(context, done) {
      ...
      var dialogue = new (Function.prototype.bind.apply(_dialogue2.default, [null].concat([context.response, context.options], _toConsumableArray(args))))();
      dialogue.scene = this;
