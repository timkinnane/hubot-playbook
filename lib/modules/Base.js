...
/**
                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                  */var
Base = function () {
  function Base(name, robot) {_classCallCheck(this, Base);
    this.name = name;
    this.robot = robot;
    ...
    this.config = {};for (var _len = arguments.length, args = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {args[_key - 2] = arguments[_key];}
  ...
  /**
    ...
    event) {var _robot;for (var _len2 = arguments.length, args = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {args[_key2 - 1] = arguments[_key2];}
    ...
    event, callback) {var _this = this;
      this.robot.on(event, function (instance) {for (var _len3 = arguments.length, args = Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1; _key3 < _len3; _key3++) {args[_key3 - 1] = arguments[_key3];}
        if (_this === instance) callback.apply(undefined, args); // eslint-disable-line
      });
    } }, { key: 'log', get: function get() {return this.robot ? this.robot.logger : null;} }]);return Base;}();exports.default =
