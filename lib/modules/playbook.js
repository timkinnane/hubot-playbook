...
var _improv = require('./improv');

var _improv2 = _interopRequireDefault(_improv);
...
var Playbook = function () {
  ...
  */
  ...
  _createClass(Playbook, [{
    key: 'use',
    value: function use(robot) {
      var improvise = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    */
    ...
    key: 'sceneEnter',
    value: function sceneEnter(res) {
      for (var _len3 = arguments.length, args = Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1; _key3 < _len3; _key3++) {
        args[_key3 - 1] = arguments[_key3];
      }

      var scene = new (Function.prototype.bind.apply(this.Scene, [null].concat([this.robot], args)))();
      var processEnter = scene.enter.apply(scene, [res].concat(args));
      this.scenes.push(scene);
      return processEnter;
    }
    ...
    */
    ...
    key: 'sceneListen',
    value: function sceneListen(type, regex) {
    ...
    */
    ...
    key: 'transcribe',
    value: function transcribe(instance) {
    ...
    */
    ...
    key: 'improvise',
    value: function improvise(options) {
    ...
    */
    ...
    value: function outline(bits) {
      ...
      outline.getSceneArgs().map(function (args) {
        return _this.sceneListen.apply(_this, _toConsumableArray(args));
      });
