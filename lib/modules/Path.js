...
(function() {
  ...
  Path = (function(superClass) {
    ...
    function Path() {
      var args, branches, robot;
      robot = arguments[0], branches = arguments[1], args = 3 <= arguments.length ? slice.call(arguments, 2) : [];
      Path.__super__.constructor.apply(this, ['path', robot].concat(slice.call(args)));
      this.branches = [];
      this.closed = true;
      if (branches != null) {
