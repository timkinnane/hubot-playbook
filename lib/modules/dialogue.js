...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  * })
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 */var
Dialogue = function (_Base) {_inherits(Dialogue, _Base);
  function Dialogue(res) {var _ref;_classCallCheck(this, Dialogue);for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {args[_key - 1] = arguments[_key];}var _this = _possibleConstructorReturn(this, (_ref = Dialogue.__proto__ || Object.getPrototypeOf(Dialogue)).call.apply(_ref, [this,
    'dialogue', res.robot].concat(args)));
    _this.defaults({
      sendReplies: false,
    ...
    _this.path = null;
    _this.ended = false;return _this;
  }
  ...
  /**
    ...
    */_createClass(Dialogue, [{ key: 'end', value: function end()
    {
    ...
    {var _res,_res2,_this2 = this;
      var sent = void 0;
      if (this.config.sendReplies) sent = (_res = this.res).reply.apply(_res, arguments);else
      sent = (_res2 = this.res).send.apply(_res2, arguments);
    ...
    /**
      ...
      */ }, { key: 'onTimeout', value: function onTimeout(
    override) {
      if (override != null) this.onTimeout = override;else
      if (this.config.timeoutText != null) this.send(this.config.timeoutText);
    }

    /**
       * Stop countdown for matching dialogue branches.
      */ }, { key: 'clearTimeout', value: function (_clearTimeout) {function clearTimeout() {return _clearTimeout.apply(this, arguments);}clearTimeout.toString = function () {return _clearTimeout.toString();};return clearTimeout;}(function ()
    {
    ...
    /**
       ...
       * ], 'which-way')
      */ }, { key: 'addPath', value: function addPath()
    {var _this4 = this;
      var result = void 0;for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {args[_key2] = arguments[_key2];}
      ...
      return Promise.resolve(result).then(function () {return _this4.path;});
    }
    ...
    /**
      ...
      */ }, { key: 'addBranch', value: function addBranch()
    {var _path;
    ...
    } }]);return Dialogue;}(_base2.default);exports.default =


Dialogue;module.exports = exports['default'];
