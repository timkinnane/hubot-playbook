...
/**
                                                                                                                                                                        ...
                                                                                                                                                                        * })
                                                                                                                                                                       */
class Dialogue extends _base2.default {
  ...
  send(...strings) {
    let sent;
    if (this.config.sendReplies) sent = this.res.reply(...strings);else
    sent = this.res.send(...strings);
  ...
  /**
    ...
    */
  addPath(...args) {
    if (_lodash2.default.isString(args[0])) this.send(args.shift());
