...
_lodash2.default.mixin({
  'hasKeys': function hasKeys(obj, keys) {return _lodash2.default.size(_lodash2.default.difference(keys, _lodash2.default.keys(obj))) === 0;} });

_lodash2.default.mixin({
  'pickHas': function pickHas(obj, pickKeys) {return _lodash2.default.omitBy(_lodash2.default.pick(obj, pickKeys), _lodash2.default.isUndefined);} });
...
/**
                                                                                                                                                       ...
                                                                                                                                                       */var
Transcript = function (_Base) {_inherits(Transcript, _Base);
  function Transcript() {var _ref;_classCallCheck(this, Transcript);for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}var _this = _possibleConstructorReturn(this, (_ref = Transcript.__proto__ || Object.getPrototypeOf(Transcript)).call.apply(_ref, [this,
    'transcript'].concat(args)));
    _this.defaults({
      save: true,
    ...
    if (_this.records == null) _this.records = [];return _this;
  }
  ...
  /**
    ...
    */_createClass(Transcript, [{ key: 'recordEvent', value: function recordEvent(
    event) {
      var instance = void 0,response = void 0;for (var _len2 = arguments.length, args = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {args[_key2 - 1] = arguments[_key2];}
      ...
      if (!_lodash2.default.isEmpty(args)) {
        if (event === 'send' && args[0].strings) record.strings = args[0].strings;else
        record.other = args;
      }
    ...
    /**
      ...
      */ }, { key: 'recordAll', value: function recordAll()
    {var _this2 = this;
      _lodash2.default.castArray(this.config.events).map(function (event) {return (
          _this2.robot.on(event, function () {for (var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {args[_key3] = arguments[_key3];}return (
              _this2.recordEvent.apply(_this2, [event].concat(args)));}));});
    ...
    /**
             ...
             */ }, { key: 'recordDialogue', value: function recordDialogue(
    dialogue) {var _this3 = this;
      ...
      dialogueEvents.map(function (event) {
        dialogue.on(event, function () {for (var _len4 = arguments.length, args = Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {args[_key4] = arguments[_key4];}return _this3.recordEvent.apply(_this3, [event, dialogue].concat(args));});
      });
      dialogue.on('path', function (path) {
        pathEvents.map(function (event) {
          path.on(event, function () {for (var _len5 = arguments.length, args = Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {args[_key5] = arguments[_key5];}return _this3.recordEvent.apply(_this3, [event, path].concat(args));});
        });
      });
    }
    ...
    /**
      ...
      */ }, { key: 'recordScene', value: function recordScene(
    scene) {var _this4 = this;
      ...
      scene.on('exit', function () {for (var _len6 = arguments.length, args = Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {args[_key6] = arguments[_key6];}
    ...
    /**
      ...
      */ }, { key: 'recordDirector', value: function recordDirector(
    director) {var _this5 = this;
      director.on('allow', function () {for (var _len7 = arguments.length, args = Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {args[_key7] = arguments[_key7];}return _this5.recordEvent.apply(_this5, ['allow', director].concat(args));});
      director.on('deny', function () {for (var _len8 = arguments.length, args = Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {args[_key8] = arguments[_key8];}return _this5.recordEvent.apply(_this5, ['deny', director].concat(args));});
    }
    ...
    /**
      ...
      */ }, { key: 'findRecords', value: function findRecords(
    subsetMatch, returnPath) {
      var found = _lodash2.default.filter(this.records, subsetMatch);
      if (returnPath == null) return found;
      var foundAtPath = found.map(function (record) {return (0, _lodash2.default)(record).at(returnPath).head();});
    ...
    /**
       ...
       * })
       *
      */ }, { key: 'findKeyMatches', value: function findKeyMatches(
    instanceKey) {for (var _len9 = arguments.length, args = Array(_len9 > 1 ? _len9 - 1 : 0), _key9 = 1; _key9 < _len9; _key9++) {args[_key9 - 1] = arguments[_key9];}
    ...
    /*
         ...
         */ }]);return Transcript;}(_base2.default);exports.default =
