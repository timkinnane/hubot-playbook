...
/**
                                                                                                                                                                        ...
                                                                                                                                                                        */
class Outline extends _base2.default {
  constructor(robot, bits, ...args) {
    super('outline', robot, ...args);
    this.scenes = [];
    this.bits = _lodash2.default.isString(bits) && _fs2.default.existsSync(bits) ? _yamljs2.default.load(bits) : bits;
    _lodash2.default.filter(this.bits, 'listen').map(bit => this.setupScene(bit));
  }
...
Outline;module.exports = exports['default'];