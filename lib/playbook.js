...
class Playbook {
  constructor() {
    if (!instance) {
      ...
      this.transcripts = [];
      this.outlines = [];
      this.Scene = _modules.Scene;
      this.Dialogue = _modules.Dialogue;
      this.Director = _modules.Director;
      this.Transcript = _modules.Transcript;
      this.Outline = _modules.Outline;
      this.improv = _modules.improv;
      instance = this;
    }
    return instance;
  }
